...
if ($curlError) {
    ...
    echo json_encode(['success'=>false,'error'=>'Erro na comunicação com a Paradise Pags','message'=>$curlError]);
    exit;
}
...
if ($httpCode >= 200 && $httpCode < 300 && is_array($data)) {
    ...
    echo json_encode(['success'=>false,'error'=>'Erro ao verificar status do pagamento','http_code'=>$httpCode,'response'=>$data ?: $response]);
}
?>
